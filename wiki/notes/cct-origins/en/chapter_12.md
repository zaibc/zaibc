...
A silence deeper than the universe itself.<br />
...
1. **Start from zero**: it must contain no bias from either civilization; otherwise, the other side cannot interpret it.
2. **Joint construction**: only when both civilizations apply causal influence to it can it form a structure understandable to both.
3. **Interpretable and influenceable**: both sides must be able to observe how their inputs change it, gradually discovering “shared semantics” within this third system.
