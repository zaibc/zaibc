...
L1 has only four permissible actions:
**stop, repeat, circle, leave**.
...
1. Perceive threat → attack  
2. Perceive anomaly → investigate  
3. Perceive civilization → attempt alignment  
